...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var list = arrayOf("Paubaya", "Ang Iwasan", "Patawad", "Handa, Awit", "Pahinga", "Doors", "Di Ka Sayang", "Lifetime",
                "Nakikinig Ka Ba Sa Akin", "Forever Beautiful", "When It Happens", "Awit Ng Bagong Taon", "Ghosting", "The Encyclopedia Salesman", "Mall Rats",
                "Patawad, Paalam", "Ikaw Pa Rin", "Beautiful", "Mabagal", "Kahit Kunwari Man Lang", "" + "UC Hymn", "UC March")
